...
class ResNet50(BaseDeepakeDetectionModel):
    """
    ResNet50 baseline model for deepfake detection.
    ...
    def __init__(self, config: Config):
        ...
        # Initialize ResNet50 with ImageNet pretrained weights
        ...
        logger.print_info(f"ResNet50 initialized with {sum(p.numel() for p in self.model.parameters())} parameters")
